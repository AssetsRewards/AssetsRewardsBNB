...
/*   AssetsRewards - Community Experimental yield farm on Binance Smart Chain.
 *   The only official platform of original AssetsRewards team! All other platforms with the same contract code are FAKE!
 *
 *   ┌───────────────────────────────────────────────────────────────────────┐
 *   │   Website: https://www.assetsrewards.com                              │
 *   │                                                                       │
 *   │   Telegram Live Support: https://t.me/assetsrewards_admin             │
 *   │   Telegram Public Chat: https://t.me/assetsrewards                    │
 *   │                                                                       │
 *   │   E-mail: admin@assetsrewards.com                                         │
 *   └───────────────────────────────────────────────────────────────────────┘
 *
 *   [USAGE INSTRUCTION]
 *
